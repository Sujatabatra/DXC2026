...
* 3. Create Application Context (Spring Container, which is responsible for maintaining the "lifecycle" of components)
...
public class SpringbootPerformerProjectApplication {
	...
	public static void main(String[] args) {
		...
		Performer performer=(Performer)springContainer.getBean("Gourav");
