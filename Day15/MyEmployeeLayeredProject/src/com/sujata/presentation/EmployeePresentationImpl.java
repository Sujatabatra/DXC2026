...
public class EmployeePresentationImpl implements EmployeePresentation {
	...
	public void performMenu(int choice) {
		...
		case 6:
			/*
			 * payslip contains all info about employee
			 * like employee id, name, desination, department, basic salary, allowances(30% of basic salary), deduction(12 %of basic salary), net salary
			 */
			System.out.println("Printing Payslip is under developement");
		case 7:
